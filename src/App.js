...
const signIn=(event)=>{
  ...
  return (
   ...
   <img className="App_headerImg" alt=""
...
<div className="app_posts">
    { 
        posts.map(({id,post})=>{
         return ( <Post key={id} username={post.username.username} caption={post.caption} imageUrl={post.imgUrl}></Post>)
        })
    }
...
{user?.displayName ? (
  <>
  <ImageUploadFile username={user.displayName}/>
  
    <div className="Suggestion">
     <Avatar 
        className="pst_avatar"
        ...
        <text className="sbutton">Switch</text>
    </div>
    <div className="Suggestion1">
     <Avatar 
        ...
        />
        <h3>NishantAJ</h3>
        <text className="sbutton">Follow</text>
    </div>
    <div className="Suggestio3">
     
        <text className="sbutton">See All</text>
    </div>
